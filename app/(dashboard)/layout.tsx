...
import { DashboardProvider, useDashboardLayout } from "./components/dashboard-context"
    ...
    <header className="border-b border-border py-2 px-4 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="flex items-center justify-between h-14">
        <div className="flex items-center gap-2 mr-6">
          ...
          <div className="hidden md:block pl-4 font-medium text-lg">{navigation.title}</div>
        </div>
